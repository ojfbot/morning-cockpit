...
type: brief
relates: rm:rm-l1-morning-cockpit#P3 (Track-L-adjacent, operator to rule), ADR-0005, ADR-0012, core wayfinder cockpit-northstar-conversation (#338, #340), core TD-007
design_package: design_handoff_cockpit_v2/ (README.md is the spec; the .dc.html is the reference)
