# Dashboard UX rollout — Control-Gated Slices (ADR-0012 + ADR-0011)

Buildable decomposition of the 2026-06-25 UX brainstorm. Source of truth:
`research/dashboard-ux-flows.md` (Flows 01 + 02), `decisions/adr/0012` (Fleet→Briefing
...
## Track F — Flow 01: Fleet selection drives the Briefing (ADR-0012)
...
## Track L — Flow 02: Launch surface + popover (ADR-0012)
...
- **Open spikes feeding later work:** L3s (popover contents), F3 C0 (transition design), and the
  default-selection policy (ADR-0012 #3, settled as fixed-home unless revisited).
