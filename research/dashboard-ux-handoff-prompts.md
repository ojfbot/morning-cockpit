...
The ADRs (`0010`, `0011`) + the two research docs live on that branch. Base each slice
...
- decisions/adr/0010-fleet-selection-drives-repo-scoped-briefing.md (decisions 1–5)
...
- decisions/adr/0010-...md (decision 7 — popover shell vs. contents deferred)
...
Read first: CLAUDE.md, CONTEXT.md, decisions/adr/0010-...md (decisions 1,2,4), decisions/adr/0007,
...
Read first: CLAUDE.md, CONTEXT.md, decisions/adr/0010-...md (decision 6),
...
selection changes. Entrance gate: F2 (real content to swap). Read decisions/adr/0010 (decision 5),
...
shape. Read decisions/adr/0010 (decision 4), research/dashboard-ux-rollout-gated-slices.md →
...
app is actually running. Entrance gates: L1 (links exist) + G1 (SDL field). Read decisions/adr/0010
